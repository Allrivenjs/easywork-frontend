	...
	return (
		<div className="p-6 mb-6 bg-white rounded-lg shadow">
			...
			<div className="flex">
				...
				<div className="ml-3">
					<Link
						to={`/profile/${props.owner.profile_slug}`}
					>
						<p className="font-bold hover:underline">{props.owner.name} {props.owner.lastname}</p>
					</Link>
					<p className="text-sm text-slate-500">Publicaco hace: {props.created_at}</p>
				</div>
			</div>
