				...
				<Container maxW={"5xl"} py={12}>
					<SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
						<Stack spacing={4}>
							...
							<Heading>
								Aprende de personas que te entienden
							</Heading>
							<Text color={"gray.500"} fontSize={"lg"}>
								En Easywork, los educadores son los ¡mismos
								estudiantes! Esto le garantiza a nuestros
								usuarios:
							</Text>
							<Stack
								spacing={4}
							...
							>
								...
								<Item
									...
									iconBg={"purple.100"}
									text={
										"Acceso a una comunidad dispuesta a ayudar"
									}
								/>
								<Item
									icon={
									...
									iconBg={"blue.100"}
									text={
										"Cursos y videos de parte de los educadores"
									}
								/>
							</Stack>
						</Stack>
